                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        ...
                        <div class="panel-body">
                            <font color="#990000">This option helps you create/manage new Projects for the organizations</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <form enctype="multipart/form-data" name="fm1" method="post" action="sett_add_project.php?typ=new" class="form-horizontal">                                
                                ...
                                <table class="table-responsive" width="100%">
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>PROJECT TITLE:</b></td>
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>PROJECT DESCRIPTION</b></td>
                                        <td width="" bgcolor="#FFFFFF">
                                            <textarea name="ndesc" id="text11" class="form-control" placeholder="Describe the blog." required="required"></textarea>
                                        </td>                                        
                                    </tr>
                                    <tr>                                        
                            ...
                            <table class="table table-striped nomargin table-bordered">
                                ...
                                <?php
                                if ($ezzzy->getrecords("news","ntype","PROJECT") == 0) {
                                    echo "<br><font color=red>No Project content added yet</font><br>";
                                }
                                else {
                                    $i = 1;
                                    $depts = $ezzzy->getallrow("ntype","PROJECT","news","id","D");
                                    foreach ($depts as $row) {
                                        include('server_blog_edit.php');
                                            ...
                                            <td bgcolor="#F0F1EB" align="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" data-toggle="modal" data-target="#myModalProjectEdit<?php echo $row['id']; ?>">Edit</a></li>
