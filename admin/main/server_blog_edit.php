...
?>
<!-- Modal -->
<form name="form1" method="post" action="sett_add_blog.php?typ=edit">
    <div class="modal bounceIn animated" id="myModalBlogEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-body2">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Blog Title <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Description of Blog <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
