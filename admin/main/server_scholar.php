<?php
$module = "registry";
$typ = "delscholar"; //when we want to delete
$shet = "scholar";
$prev = "msholar";
                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        <div class="panel-heading">
                            <h4 class="panel-title"> MANAGE ADMINISTRATORS</h4>
                        </div>

                        <div class="panel-body">
                            <font color="#990000">This option helps you create/manage Administrators for the community</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <form enctype="multipart/form-data" name="fm1" method="post" action="sett_add_scholar.php?typ=new" class="form-horizontal">
                                ...
                                <table class="table-responsive" width="100%" border="1">
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>RANK/POSITION:*</b></td>
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="text" name="rank" class="form-control" placeholder="E.g: Director" required="required" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="text" name="nation" class="form-control" placeholder="E.g: Nigerian" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="tel" name="phone" class="form-control" placeholder="+2348064980757" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="email" name="email" class="form-control" placeholder="ekitiparapo@domain.com" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="url" name="facebook" class="form-control" placeholder="https://www.facebook.com/ekitiparapo" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="url" name="twitter" class="form-control" placeholder="https://www.twitter.com/ekitiparapo" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="url" name="linkedin" class="form-control" placeholder="https://www.twitter.com/ekitiparapo" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="" bgcolor="#FFFFFF">
                                            <textarea name="bio" class="form-control" placeholder="Take this opportunity to say more about this Administrator"></textarea>
                                        </td>                                        
                                    </tr>
                            ...
                            <table class="table table-striped nomargin table-bordered">
                                <tr>
                                    ...
                                    <th width="" bgcolor="#F0F1EB" valign="middle"> RANK/POSITION </th>
                                    <th width="" bgcolor="#F0F1EB" align="center">&nbsp;</th>
                                </tr>				
                                <?php
                                if ($ezzzy->getrecords("dir_scholars") == 0) {
                                    echo "<br><font color=red>No scholar added yet</font><br>";
                                } else {
                                    $amts = array();
                                    $i = 1;
                                    $depts = $ezzzy->runQuery("select * from dir_scholars order by id desc");
                                    foreach ($depts as $row) {
                                        include('server_scholars_edit.php');
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#F0F1EB" valign="middle"> <?php echo $row['rank']; ?> </td>
