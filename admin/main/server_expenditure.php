                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        <div class="panel-heading">
                            <h4 class="panel-title"> MANAGE EXPENDITURES</h4>
                        </div>

                        <div class="panel-body">
                            <font color="#990000">This option helps you create/manage new Expenditures for the store</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <form enctype="multipart/form-data" name="fm1" method="post" action="sett_add_expenditure.php?typ=new" class="form-horizontal">                                
                                ...
                                <input type="hidden" value="Expenditure" name="ttype" />
                            ...
                            <table class="table table-striped nomargin table-bordered">
                                ...
                                if ($ezzzy->getrecords("incomexp") == 0) {
                                    ...
                                    $amts = array();
                                    $i = 1;
                                    //$depts = $ezzzy->getallrow("ttype","Expenditure","incomexp");
                                    $depts = $ezzzy->runQuery("SELECT * FROM incomexp WHERE ttype='Expenditure' order by id desc limit 50");
                                            ...
                                            <td bgcolor="#F0F1EB" align="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" data-toggle="modal" data-target="#myModalExpenseEdit<?php echo $row['id']; ?>">Edit</a></li>
