...
if ($_GET['typ'] == "new") {
    ...
    if ($ntitle == "" || $ndesc == "") {
        display_error("Please, specify the blog Title and hence provide a description for the blog");
        ...
        if (is_uploaded_file($_FILES['pic']['tmp_name'])) {
            ...
            $vals = "'$ntitle',,'$ndesc',,'BLOG',,'$adate',,'$now',,'$filest'";
            ...
            $vals = "'$ntitle',,'$ndesc',,'BLOG',,'$adate',,'$now'";
            $result = $ezzzy->addlist($fields, $vals, "news");
            if (!$result) {
                $_SESSION["msg"] = '<font color=red><b>Invalid Operation! </b> ' . ' No action taken. Try again<br><br></font>';
            }
