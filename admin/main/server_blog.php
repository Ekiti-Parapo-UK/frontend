                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        ...
                        <div class="panel-body">
                            <font color="#990000">This option helps you create/manage new Blog for the institution</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <form enctype="multipart/form-data" name="fm1" method="post" action="sett_add_blog.php?typ=new" class="form-horizontal">                                
                                ...
                                <table class="table-responsive" width="100%">
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>BLOG TITLE:</b></td>
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>BLOG DESCRIPTION (ARTICLE)</b></td>
                                        <td width="" bgcolor="#FFFFFF">
                            ...
                            <table class="table table-striped nomargin table-bordered">
                                ...
                                <?php
                                if ($ezzzy->getrecords("news","ntype","BLOG") == 0) {
                                    echo "<br><font color=red>No blog content added yet</font><br>";
                                }
                                else {
                                    $i = 1;
                                    $depts = $ezzzy->getallrow("ntype","BLOG","news","id","D");
                                            ...
                                            <td bgcolor="#F0F1EB" align="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" data-toggle="modal" data-target="#myModalBlogEdit<?php echo $row['id']; ?>">Edit</a></li>
