...
?>
<!-- Modal -->
<form name="form1" method="post" action="sett_add_income.php?typ=edit">
    <div class="modal bounceIn animated" id="myModalIncomeEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Edit Income (<?php //echo $row['name']; ?>)</h4>
                </div>
