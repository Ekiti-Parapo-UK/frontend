...
$myphoto = $ezzzy->getval("id",$adminid,"dir_students","photo");
?>
    <!DOCTYPE html>
<html lang="en">
<head>
...
<header>
  <div class="headerpanel">
    ...
    <div class="logopanel">
      <h2><a href="./?lnk=dashboard_std"><img height="55" src="images/cdllogo.png" /></a></h2>
    </div><!-- logopanel -->
                        ...
                        <ul class="list-group notice-list">
                          <li class="list-group-item unread">
                            <div class="row">
                              ...
                              <div class="col-xs-10">
                                <h5><a href="#">New message from ezzzy</a></h5>
                                <small>June 20, 2019</small>
                                <span>This is some of the message...</span>
                              </div>
                            </div>
                          </li>
            ...
            <li>
              <div class="btn-group">
                <button type="button" class="btn btn-logged" data-toggle="dropdown">
                  <img src="<?php if($myphoto == "" || $myphoto == null){ echo "pics/user.png"; } else { echo $myphoto; } ?>" alt="" />
    ...
    <div class="leftpanelinner">
      ...
      <div class="media leftpanel-profile">
        <div class="media-left">
          <a href="#">
            <img src="<?php if($myphoto == "" || $myphoto == null){ echo "pics/user.png"; } else { echo $myphoto; } ?>" alt="" class="media-object img-circle">
          </a>
        </div>
        <div class="media-body">
          ...
          <span><?php echo $ezzzy->getval("id",$adminid,"dir_students","regno"); ?></span>
        </div>
      ...
      <div class="leftpanel-userinfo collapse" id="loguserinfo">        
        ...
        <ul class="list-group">
          <li class="list-group-item">
            <label class="pull-left">Last Login</label>
            <span class="pull-right"><?php echo $ezzzy->getval("id",$adminid,"_accounts","lastlogin"); ?></span>
          </li>
          <li class="list-group-item">
            <label class="pull-left">Mobile</label>
            <span class="pull-right"><?php echo $ezzzy->getval("id",$adminid,"dir_students","phone"); ?></span>
          </li>
          <!--<li class="list-group-item">
