<div class="tab-content">
        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            <li class="active"><a href="./?lnk=payschf"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
          </ul>

          <h5 class="sidebar-title">Main Menu</h5>
          <ul class="nav nav-pills nav-stacked nav-quirk">
              <li class="<?php if(isset($shet) && $shet == "npact"){ echo "active"; } ?>"><a href="./?lnk=payschf&action=npaya">Payment Activities</a></li>
              <li class="<?php if(isset($shet) && $shet == "logout"){ echo "active"; } ?>"><a href="./?lnk=logout">Logout</a></li>
          </ul>
        </div><!-- tab-pane -->
