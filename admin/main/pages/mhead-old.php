...
<header>
  <div class="headerpanel">
    ...
    <div class="logopanel">
      <h2><a href="./?lnk=dashboard"><img height="55" src="../../images/logo.png" /></a></h2>
    </div><!-- logopanel -->
    ...
    <div class="leftpanelinner">
      ...
      <div class="media leftpanel-profile">
        ...
        <div class="media-body">
          ...
          <span><?php echo $ezzzy->getval("id",$adminid,"dir_members","regno"); ?></span>
        </div>
      ...
      <div class="leftpanel-userinfo collapse" id="loguserinfo">        
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">
            ...
            <span class="pull-right"><?php echo $ezzzy->getval("id",$adminid,"dir_members","phone"); ?></span>
          </li>
          <!--<li class="list-group-item">
