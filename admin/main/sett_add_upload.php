...
if ($_GET['typ'] == "new") {
    ...
    if ($ntitle == "" || $ndesc == "") {
        display_error("Please, specify the file Title and hence provide a description for the file");
    } else if ($ezzzy->getrecords("news", "title", $ntitle) != 0) {
        display_error("Oops!! It seems you have added this file item before");
    } else {
        //all is well
        if (is_uploaded_file($_FILES['pic']['tmp_name'])) {
            ...
            $vals = "'$ntitle',,'$ndesc',,'FILE',,'$adate',,'$now',,'$filest'";
            ...
            $vals = "'$ntitle',,'$ndesc',,'FILE',,'$adate',,'$now'";
            $result = $ezzzy->addlist($fields, $vals, "news");
            if (!$result) {
                $_SESSION["msg"] = '<font color=red><b>Invalid Operation! </b> ' . ' No action taken. Try again<br><br></font>';
            }
