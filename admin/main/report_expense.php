                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        <div class="panel-heading">
                            <h4 class="panel-title"> EXPENDITURE REPORT</h4>
                        </div>

                        <div class="panel-body">
                            <font color="#990000">This option helps you view expenditure report periodically</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <div class="pull-right" style="margin-right:100px;">
                                <a href="javascript:Clickheretoprint()" style="font-size:20px;"><button class="btn btn-success btn-large"><i class="icon-print"></i> Print</button></a>
                            </div>
                            <hr />
                            <form action="./?lnk=report_expense" method="post">
                                <center>
                                    <strong>
                                        <div class="row">
                            ...
                            <div class="content" id="content">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['searchr'])) {
                                        ...
                                        $result = $ezzzy->runQuery("SELECT * FROM incomexp WHERE scode='$sh' and (dates>='$d1' and dates<='$d2') and ttype='Expenditure' order by dates desc");                                        
                                    } else {
                                        //$result = $ezzzy->runQuery("SELECT * FROM sales order by dates desc");
                                    }
                                    $tamt = array();
                                    foreach ($result as $row) {
                                        include('server_expenditure_edit.php');
                                        ...
                                        <tr class="record">
                                            ...
                                            <td><a href="#" data-toggle="modal" data-target="#myModalExpenseEdit<?php echo $row['id']; ?>"><span class="label label-success"><i class="fa fa-edit"></i> Edit </span></a> <br/><a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $row['id']; ?>"><span class="label label-danger"><i class="fa fa-close"></i> Del </span></a></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
