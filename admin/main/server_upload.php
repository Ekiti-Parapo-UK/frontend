                ...
                <div class="row">
                    <div class="panel panel-inverse panel-site-traffic">
                        ...
                        <div class="panel-body">
                            <font color="#990000">This option helps you create/manage new Uploads for the institution</font><br><br>
                            <strong><?php echo @$_SESSION['msg']; ?></strong>
                            <form enctype="multipart/form-data" name="fm1" method="post" action="sett_add_upload.php?typ=new" class="form-horizontal">                                
                                ...
                                <table class="table-responsive" width="100%">
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>FILE TITLE:</b></td>
                                    ...
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>UPLOAD FILE:</b></td>
                                        <td width="" bgcolor="#FFFFFF">
                                            <input type="file" name="pic" class="form-control" placeholder="Upload File" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="" bgcolor="#FFFFFF"><b>FILE DESCRIPTION</b></td>
                                        <td width="" bgcolor="#FFFFFF">
                                            <textarea name="ndesc" id="text11" class="form-control" placeholder="Describe the file." required="required"></textarea>
                                        </td>                                        
                                    </tr>
                                    <tr>                                        
                            ...
                            <table class="table table-striped nomargin table-bordered">
                                <tr>
                                    ...
                                    <th width="" bgcolor="#F0F1EB" valign="middle"> FILE </th>
                                    <th width="" bgcolor="#F0F1EB" align="center">&nbsp;</th>
                                </tr>				
                                <?php
                                if ($ezzzy->getrecords("news","ntype","FILE") == 0) {
                                    echo "<br><font color=red>No upload content added yet</font><br>";
                                }
                                else {
                                    $i = 1;
                                    $depts = $ezzzy->getallrow("ntype","FILE","news","id","D");
                                    foreach ($depts as $row) {
                                        //include('server_upload_edit.php');
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#F0F1EB" valign="middle"> <?php echo substr($row['descp'],0,100); ?> ...</td>
                                            <td bgcolor="#F0F1EB" valign="middle"> <?php echo $row['picture']; ?> </td>
                                            <td bgcolor="#F0F1EB" align="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" data-toggle="modal" data-target="#myModalUploadEdit<?php echo $row['id']; ?>">Edit</a></li>
