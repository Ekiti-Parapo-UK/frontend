    ...
    <section class="">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h6 class="letter-space-4 text-gray-darkgray text-uppercase mt-0 mb-0">Aims</h6>
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">& Objectives</h2>
              <p><?php echo $ezzzy->getval("page","aim","siteinfo","detail"); ?></p>
