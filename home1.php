...
<meta name="description" content="IIAS, ezzzy, Ezekiel, Aliyu, Institute of Advance Studies, Ile Ife Osun State Nigeria" />
<meta name="keywords" content="ezzzy, Aliyu, Ezekiel, academy, course, education, education ile ife, elearning, learning," />
<meta name="author" content="Ezekiel Aliyu ezzzy" />

<!-- Page Title -->
<title>IIAS | Welcome</title>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h2 class="text-uppercase mt-0 font-weight-600">Welcome To <span class="text-theme-colored">Studypress</span><br> HTML5 Tempalte</h2>
            ...
            <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="row mb-10">
                <div class="col-md-12">
                  <img class="img-fullwidth" src="http://placehold.it/560x200" alt="">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 pr-5 pr-sm-15 mb-sm-10">
                  <img class="img-fullwidth" src="http://placehold.it/275x197" alt="">
                </div>
