    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/web/tede2.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">Our Goal</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="./?lnk=home">Home</a></li>
                <li class="active text-gray-silver">Our Goal</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              ...
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Goal</h2>
              <p><?php echo $ezzzy->getval("page","goal","siteinfo","detail"); ?></p>
            </div>
            <div class="col-md-6">
