    ...
    <section id="news">
      <div class="container">
        <div class="section-content">
          <div class="row">
              <?php
               $blog = $ezzzy->runQuery("SELECT * FROM news WHERE ntype='BLOG' order by id desc");
               foreach ($blog as $row){
              ...
              <article class="post clearfix mb-30 mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="" alt="330x225" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                  ...
                  <div class="entry-meta media mt-0 no-bg no-border">
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="./?lnk=blog_det&amp;id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h4>
                        <!--<span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>                       
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>-->
                      </div>
                    </div>
                  </div>
                    <p class="mt-10"><?php echo substr($row['descp'], 0,100); ?></p>
